...
export class GranularEmployeePermissionCatalog1788787200000 implements MigrationInterface {
  ...
  private readonly rows: CatalogRow[] = [
    ...
    [
      ...
      'اعتبار و تسویه',
      'cr_view',
      'مشاهده اعتبار و تسویه آژانس‌ها',
    ],
    [
      'finance',
      'credit',
      'اعتبار و تسویه',
      'cr_manage',
      'مدیریت اعتبار و تسویه آژانس‌ها',
    ],
    [
      'finance',
      'reports',
    ...
    [
      ...
      'امنیت',
      'sc_sessions',
      'مدیریت نشست‌ها و خروج همه کاربران',
    ],
