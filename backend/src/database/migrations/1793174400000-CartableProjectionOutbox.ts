...
export class CartableProjectionOutbox1793174400000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TRIGGER "cartable_projection_audits_append_only_guard" BEFORE UPDATE OR DELETE ON "ops"."cartable_projection_audits" FOR EACH ROW EXECUTE FUNCTION "audit"."reject_immutable_row_mutation"()`,
    );
  }
