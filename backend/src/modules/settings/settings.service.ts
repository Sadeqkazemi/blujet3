...
export const DEFAULT_SITE_RULES: SiteRules = {
  categories: [
    ...
    },
    {
      ...
      text: '۱. بیش از ۷۲ ساعت مانده به پرواز، جریمهٔ استرداد ۳۰٪ است.\n۲. بین ۲۴ تا ۷۲ ساعت، جریمه ۵۰٪ و بین ۱۲ تا ۲۴ ساعت، جریمه ۷۰٪ است.\n۳. کمتر از ۱۲ ساعت مانده به پرواز یا پس از پرواز، استرداد غیرمجاز است.\n۴. پس از ثبت درخواست، ادمین سایت آن را بررسی و به واحد مالی ارجاع می‌دهد؛ مبلغ قابل بازگشت حداکثر تا ۷ روز کاری واریز می‌شود.',
    },
    {
      id: 'change',
