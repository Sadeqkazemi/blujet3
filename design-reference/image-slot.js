...
(() => {
  ...
  const stylesheet =
    ...
    '  font:14px/1.35 Vazirmatn,system-ui,-apple-system,sans-serif;color:rgba(15,22,35,.6);width:240px;height:160px}' +
    ...
    '  justify-content:center;gap:7px;text-align:center;padding:10px;box-sizing:border-box;' +
    '  cursor:pointer;user-select:none}' +
    '.empty svg{opacity:.5}' +
    '.empty .cap{max-width:96%;font-weight:600;font-size:13px;letter-spacing:.01em}' +
    '.empty .sub{font-size:11.5px;white-space:nowrap}' +
  ...
  class ImageSlot extends HTMLElement {
    ...
    constructor() {
      ...
      root.innerHTML =
        ...
        '    <div class="cap"></div>' +
        '    <div class="sub">یا <u>انتخاب فایل</u></div></div>' +
