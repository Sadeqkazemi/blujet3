...
const BASE_READER_COLUMNS = [
  {
    ...
    columns: ['id', 'userId', 'level', 'cardStatus', 'deactivatedAt'],
  },
  {
    schema: 'loyalty',
    relation: 'club_points_entries',
    columns: ['clubMemberId', 'signedPoints'],
  },
  {
    schema: 'loyalty',
    relation: 'price_locks',
    columns: [
      'id',
      'userId',
      'flightInstanceId',
...
const MEMBERS_LIST_READER_COLUMNS = [
  {
    schema: 'loyalty',
    relation: 'club_members',
    columns: [
